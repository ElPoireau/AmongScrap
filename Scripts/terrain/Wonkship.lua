...
WonkShipWorld.enableCreations = true
...
--[[
function WonkShipWorld.server_onCreate( self )
    print("WonkShipWorld.server_onCreate")
end
--]]
...
function WonkShipWorld.client_onCreate( self )
	...
	print( "WonkShipWorld.client_onCreate" )
...
function WonkShipWorld.client_onDestroy( self )
...
function WonkShipWorld.server_onRefresh( self )
end

function WonkShipWorld.server_onFixedUpdate( self )
...
function WonkShipWorld.client_onUpdate( self, deltaTime )
...
function WonkShipWorld.cl_n_unitMsg( self, msg )
	g_unitManager[msg.fn]( g_unitManager, msg )
end

function WonkShipWorld.sv_loadShipOrStationOnCell( self, x, y )
...
function WonkShipWorld.sv_loadHideoutOnCell( self, x, y )
...
function WonkShipWorld.sv_loadPathNodesOnCell( self, x, y )
...
function WonkShipWorld.sv_reloadPathNodesOnCell( self, x, y )
...
function WonkShipWorld.sv_loadSpawnersOnCell( self, x, y )
...
function WonkShipWorld.sv_reloadSpawnersOnCell( self, x, y )
	local nodes = sm.cell.getNodesByTag( x, y, "PLAYER_SPAWN" )
	g_respawnManager:sv_setLatestSpawners( nodes )
end
...
function WonkShipWorld.server_onCellCreated( self, x, y )
...
function WonkShipWorld.client_onCellLoaded( self, x, y )
	BaseWorld.client_onCellLoaded( self, x, y )
end

function WonkShipWorld.server_onCellLoaded( self, x, y )
...
function WonkShipWorld.server_onCellUnloaded( self, x, y )
	BaseWorld.server_onCellUnloaded( self, x, y )
	--print( "WonkShipWorld - cell ("..x..","..y..") unloaded" )
	g_unitManager:sv_onWorldCellUnloaded( self, x, y )
end

function WonkShipWorld.client_onCellUnloaded( self, x, y )
	BaseWorld.client_onCellUnloaded( self, x, y )
	--print( "WonkShipWorld - client cell ("..x..","..y..") unloaded" )
end


function WonkShipWorld.server_onProjectile( self, hitPos, hitTime, hitVelocity, _, attacker, damage, userData, hitNormal, target, projectileUuid )
...
function WonkShipWorld.sv_ambush( self, params )
...
function WonkShipWorld.sv_e_spawnRaiders( self, params )
...
function WonkShipWorld.sv_e_spawnTempUnitsOnCell( self, params )
