...
Overworld = class( nil )
Overworld.terrainScript = "$CONTENT_DATA/Scripts/terrain/TerrainScript/SpawnTerrain.lua"
Overworld.groundMaterialSet = "$GAME_DATA/Terrain/Materials/gnd_standard_materialset.json"
Overworld.enableSurface = false
...
--Overworld.isIndoor = true
Overworld.renderMode = "warehouse"
Overworld.cellMinX = 0
Overworld.cellMaxX = 0
Overworld.cellMinY = 0
Overworld.cellMaxY = 0
...
-- CONTENT --
function Overworld.cl_onGameOver( self )
