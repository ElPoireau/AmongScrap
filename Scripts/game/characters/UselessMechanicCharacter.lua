-- Copy of MechanicCharacter.lua but without BaseCharacter class


dofile( "$CONTENT_DATA/Scripts/game/characters/UselessBaseCharacter.lua" )

UselessMechanicCharacter = class( UselessBaseCharacter )
...
function UselessMechanicCharacter.server_onCreate( self )
	UselessBaseCharacter.server_onCreate( self )
...
function UselessMechanicCharacter.client_onCreate( self )
	UselessBaseCharacter.client_onCreate( self )
	self.animations = {}
	...
	self.chewing = false
	print( "-- UselessMechanicCharacter created --" )
	self:client_onRefresh()
end

function UselessMechanicCharacter.client_onDestroy( self )
	print( "-- UselessMechanicCharacter destroyed --" )
end

function UselessMechanicCharacter.client_onRefresh( self )
	print( "-- UselessMechanicCharacter refreshed --" )
end

function UselessMechanicCharacter.client_onGraphicsLoaded( self )
	UselessBaseCharacter.client_onGraphicsLoaded( self )
...
function UselessMechanicCharacter.client_onGraphicsUnloaded( self )
	UselessBaseCharacter.client_onGraphicsUnloaded( self )
...
function UselessMechanicCharacter.client_onUpdate( self, deltaTime )
	UselessBaseCharacter.client_onUpdate( self, deltaTime )
...
function UselessMechanicCharacter.client_onEvent( self, event )
	self:cl_handleEvent( event )
end

function UselessMechanicCharacter.cl_e_onEvent( self, event )
	self:cl_handleEvent( event )
end

function UselessMechanicCharacter.cl_handleEvent( self, event )
...
function UselessMechanicCharacter.cl_e_onCancel( self )
...
function UselessMechanicCharacter.cl_onEffect( self, params )
	sm.effect.playEffect( params.effectName, params.position, params.velocity, params.rotation, params.scale, params.effectParams )
end

function UselessMechanicCharacter.cl_network_onEffect( self, params ) 
	if params.player ~= sm.localPlayer.getPlayer() then
		self:cl_onEffect( params )
	end
end

function UselessMechanicCharacter.sv_network_onEffect( self, params )
